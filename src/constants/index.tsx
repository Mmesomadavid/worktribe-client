...
export const heroData = {
  sectionSubtitle: 'AI-Powered Job Board',
  sectionTitle: 'Strategic Clarity',
  sectionTitle2: 'Sustainanble Growth',
  decoTitle: 'Built for Scale',
  sectionText:
    'Next-gen career accelerator: Apply to over 100 relevant jobs in a single click.',
};
