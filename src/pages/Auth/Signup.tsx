...
const Signup = () => {
  ...
  const inputClass =
    'pl-10 pr-4 py-3 h-11 bg-gray-900 border border-gray-800 rounded-xl text-white placeholder-gray-600 focus:border-lime-400 focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 transition-colors text-sm';
    ...
    <div ref={containerRef} className="min-h-screen bg-background text-white flex flex-col">
      ...
      <div className="flex flex-1 flex-col lg:flex-row">
        ...
        <div
          ref={leftRef}
          style={{ opacity: 0 }}
          className="flex-1 flex flex-col justify-center px-8 sm:px-14 lg:px-20 py-10 lg:py-14"
        >
          ...
          <div className="flex flex-col gap-5 max-w-lg">
                  ...
                  <button
                    ...
                    className={`flex-1 h-11 rounded-xl border text-sm font-medium transition-all capitalize ${
                      accountType === type
                        ...
                        : 'bg-gray-900 border-gray-800 text-gray-400 hover:border-lime-400/50'
                    }`}
                  >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative flex items-center">
                ...
                <select
                  id="country"
                  className="w-full h-11 pl-10 pr-10 bg-gray-900 border border-gray-800 rounded-xl text-sm text-gray-300 focus:border-lime-400 focus:outline-none transition-colors appearance-none"
                >
        ...
        <div className="hidden lg:flex flex-col items-center justify-center py-14">
          <Separator orientation="vertical" className="h-full bg-gray-800 w-px" />
        </div>
        ...
        <div
          ref={rightRef}
          style={{ opacity: 0 }}
          className="flex flex-col justify-center items-center px-8 sm:px-14 lg:px-20 py-10 lg:py-14 lg:w-[420px] shrink-0"
        >
          <div className="w-full max-w-xs flex flex-col gap-6">
            ...
            <button
              type="button"
              className="flex items-center gap-4 w-full h-12 bg-gray-900 hover:bg-gray-800 border border-gray-800 hover:border-gray-700 rounded-xl px-5 transition-all group"
            >
              {/* Google SVG icon */}
